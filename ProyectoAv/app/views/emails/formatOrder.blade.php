...
<body>		
	<table class="header">
		<tr>
			...
			<td>
				<p class="text-center" style="margin-bottom:15px; background:1px solid #EEE">Fecha {{$order->estimation->created_at}}</p>
				<div class="nums">
			...
			<td class="text-center">
				<p style="margin-bottom:10px; background:1px solid #EEE">00000{{$order->estimation->id}}</p>
				<div>
	...
	<table class="table-data border">
		<tr>
			...
			<td colspan="3"><span>{{$order->estimation->date_event}}</span></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>RECOGER</td>			
			<td colspan="2"><span>{{$order->estimation->date_collecting}}</span></td>
		</tr>
		<tr>
			<td>TEL</td>
			...
			<td>SURTIR</td>			
			<td colspan="2"><span>{{$order->estimation->date_range}}</span></td>
		</tr>	
		<tr>
